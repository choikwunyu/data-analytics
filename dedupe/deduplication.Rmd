...
dir <- tk_choose.dir(default = "", caption = "Select folder")
list.filenames<-list.files(dir,pattern="*.csv")
#extract files based on duplicated utctime
for (i in 1:length(list.filenames))
{
  patient<-read_csv(paste(dir,"/",list.filenames[i],sep = ""))
  patient_cbg<-subset(patient,patient$type=="cbg")
  if ((length(unique(patient_cbg$time)))!=nrow(patient_cbg))
...
#0289cfb8bd6d61ccf1f31c07aa146b7b14f0eb74474be4311860d9d77dd30f15.csv
